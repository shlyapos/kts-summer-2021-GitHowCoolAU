...
export default class ReposListStore implements ILocalStore {
    private _list: CollectionModel<number, GitHubRepoItemModel> = getInitialCollectionModel();
    ...
    async updateList(params: GitHubGetRepoParams): Promise<void> {
        ...
        const response: ApiResponse<GitHubRepoItemApi[], ResponseError> = await rootStore.apiRequest({
